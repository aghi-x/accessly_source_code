...
const updateRole = async (formData) => {
  ...
  try {
    const response = await axios.put(`/roles/${props.role.id}`, formData, {
    ...
    if (response.data.success === false) {
      if (response.data.errors) {
        ...
        // For cases like trying to edit "admin" role
...
<!-- Right column (9/12) -->
<div
:class="['bg-base-100 p-4 transition-all duration-300', sidebarOpen ? 'col-span-12 md:col-span-9 lg:col-span-10 xl:col-span-10' : 'col-span-12']">
...
>
  <div class="alert alert-success text-sm text-white shadow-lg">
    ...
    <span>Role updated successfully.</span>
      ...
      <RoleForm :role="role" :allPermissions="allPermissions" :action="action" @submit="updateRole"/>
