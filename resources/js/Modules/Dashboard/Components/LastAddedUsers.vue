...
<template>
      ...
      <ul class="list bg-[#d1dffe4f] rounded-box shadow-md">
    
    <li class="p-4 pb-2 text-xs opacity-60 tracking-wide">Recent Registrations</li>
    
    <li
      v-for="(user) in recentRegistration"
      :key="user.id"
      class="list-row"
    >
      ...
      <div>
        ...
        <div v-else class="size-10 rounded-box bg-gray-200 flex items-center justify-center text-xs text-gray-500">
          N/A
        </div>
      </div>
