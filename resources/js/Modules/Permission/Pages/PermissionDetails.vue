...
<div class="flex items-center justify-between mb-6">
  <h1 class="text-2xl font-bold">Permissions Details</h1>
</div>
...
<!-- Header -->
<!-- <h2 class="text-2xl font-bold">🔐 Permission</h2> -->
<p class="text-lg text-info">{{ name }}</p>
